	...
	*/
	public FormantSequence(String soundName) {
		...
		if(soundName.compareTo("i")==0){
			list.add(new Formant(285.0, 28.0, 0.0));
			list.add(new Formant(2373.0, 450.0, 0.0));
			...
			this.setAutorisedMargin(0.1);
		}else if(soundName.compareTo("u")==0){
			list.add(new Formant(309.0,40.5,0));
			list.add(new Formant(939.0,416.0,0));
			list.add(new Formant(2320.0,0.0,0));
			this.setAutorisedMargin(0.1);
		}else{
			list.add(new Formant());
			list.add(new Formant());
