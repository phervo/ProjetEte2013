...
public class MessageToPraat {
	 ...
	 * 
	 */
	private static final double Speachtime=0.5;
	/**
	...
	public static String writePraatScriptWithCandidates(Sequence candidat) throws PraatScriptException{ // catch a corrige pareil en dessous
			if(candidat.getLength()==nbVarToSendToPraat){
				...
				try {
					...
					stb.append("Set target... "+Speachtime+"   "+candidat.getValuesAt(4)+" Cricothyroid\n");
					stb.append("# Close velopharyngeal port\n");
					stb.append("#-----------------------------------------------\n");
					stb.append("Set target... 0.0   "+candidat.getValuesAt(5)+" LevatorPalatini\n");
					stb.append("Set target... "+Speachtime+"   "+candidat.getValuesAt(6)+" LevatorPalatini\n");
					stb.append("#-----------------------------------------------\n");
					stb.append("#-----------------------------------------------\n");
					stb.append("Set target... 0.0   "+candidat.getValuesAt(7)+" Genioglossus\n");
					stb.append("Set target... "+Speachtime+"   "+candidat.getValuesAt(8)+" Genioglossus\n");
					stb.append("#\n");
					stb.append("Set target... 0.0   "+candidat.getValuesAt(9)+" Styloglossus\n");
					stb.append("Set target... "+Speachtime+"   "+candidat.getValuesAt(10)+" Styloglossus\n");
					stb.append("#\n");
					stb.append("Set target... 0.0   "+candidat.getValuesAt(11)+" Mylohyoid\n");
					stb.append("Set target... "+Speachtime+"   "+candidat.getValuesAt(12)+" Mylohyoid\n");
					stb.append("#\n");
					stb.append("Set target... 0.0   "+candidat.getValuesAt(13)+" OrbicularisOris\n");
					stb.append("Set target... "+Speachtime+"   "+candidat.getValuesAt(14)+" OrbicularisOris\n");
					stb.append("#-----------------------------------------------\n");
					...
					stb.append("Set target... "+Speachtime+"   "+candidat.getValuesAt(16)+" Masseter\n");
					stb.append("# Pull tongue backwards\n");
					stb.append("Set target... 0.0   "+candidat.getValuesAt(17)+" Hyoglossus\n");
					stb.append("Set target... "+Speachtime+"   "+candidat.getValuesAt(18)+" Hyoglossus\n");
	...
	*
	*/
	public static void writePraatScriptInFile(Sequence candidat) throws PraatScriptException{
		if(candidat.getLength()==nbVarToSendToPraat){
			String adressedufichier = System.getProperty("user.dir") + "/praatScriptWithCorrectValues";
			StringBuilder stb= new StringBuilder(); 
			stb.append("#-----------------------------------------------\n");
			stb.append("# Project : Software synthesis using GA\n");
			stb.append("# Hervo Pierre-Yves, automatic Script generated in java\n");
