...
public class MessageToPraat {
	 ...
	 * 
	 */
	private static final int nbFormantMax=3; //barre superieure de recherche
	...
	public static void writePraatScriptWithCandidates(Sequence candidat) throws PraatScriptException{ // catch a corrige pareil en dessous
			if(candidat.getLength()==nbVarToSendToPraat){
				...
				try {
					...
					stb.append("#First verification : no --undefined-- values \n");
					stb.append("if temp1$ <> \"--undefined--\" and temp2$ <> \"--undefined--\" and temp3$ <> \"--undefined--\" and temp4$ <> \"--undefined--\"\n");
					stb.append("#Second verification : value of mean in a good interval \n");
					stb.append("temp5 = Get mean... intervalNumber 0 0 Hertz\n");
					stb.append("appendInfoLine(\"Valeur moyenne pour Formant\",intervalNumber,\" :\",temp5)\n");
					stb.append("if intervalNumber = 1 and temp5 >= 230\n");
					stb.append("appendInfoLine(\"On est ok interval 1\")\n");
					stb.append("varMeans[1]=temp5\n");
					stb.append("elsif intervalNumber = 2 and temp5 >= 940\n");
					stb.append("appendInfoLine(\"On est ok interval 2\")\n");
					stb.append("varMeans[2]=temp5\n");
					stb.append("elsif intervalNumber = 3 and temp5 >= 2300\n");
					stb.append("appendInfoLine(\"On est ok interval 3\")\n");
					stb.append("varMeans[3]=temp5\n");
					stb.append("else\n");
					stb.append("appendInfoLine(\"On est pas ok\")\n");
					stb.append("varMeans[1]=0\n");
					stb.append("varMeans[2]=0\n");
					stb.append("varMeans[3]=0\n");
